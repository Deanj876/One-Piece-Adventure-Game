...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        playerStats ps = new playerStats(100, 10, 5);
        shop s = new shop(ps);
        mapAndCombat mac = new mapAndCombat(ps);

        // Player Info Gather
        // Player Name
        System.out.println(s.ev.getPlayerName() + ": Hello Grand Line!!!");
...
<<<<<<< HEAD
        ...
        // Start to the game
        System.out.println("\n" + s.ev.getPlayerName() + ": Time to start my adventure to become a great pirate!");
        int gameLoop = 0;
        while (true) {
            timeDelay();
            ...
            // Player sleeps
                ...
                // Progresses the day
                s.ev.dayCounter += 1;
                System.out.println("\nThe Day is: " + s.ev.dayCounter);

            } else if (input.equals("2")) {
                System.out.println(s.ev.getPlayerName() + " goes to the local shop on the island!");
                s.playerShop();
=======
        System.out.print("\033[H\033[2J");  
        System.out.flush();
...
>>>>>>> parent of defe426 (Working on Combat)
                ...
                System.out.println(s.ev.getPlayerName() + ": Lets see where the log post will take me!");
                mac.map();
            }
